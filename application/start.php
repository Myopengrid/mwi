...
Autoloader::map(array(
    ...
    'Public_Controller'     => path('app').'controllers/Public.php',
    'Private_Controller'    => path('app').'controllers/Private.php',
...
|--------------------------------------------------------------------------
|
| Load all magic methods available globaly in the application
|
*/
include(path('app').'helpers.php');