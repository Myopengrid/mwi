        ...
        <table class="table table-bordered" border="0">
            ...
            @foreach($news as $the_news)
                <tr id="flash-news-row-{{$the_news->id}}">
                    ...
                    <td><a class="cboxElement" target="_blank" rel="modal-large" href="{{ URL::base().'/'.Config::get('settings::core.splashscreen_flash_news_handler').'/'.$the_news->slug }}">{{ Str::title($the_news->title) }}</a></td>
...
<div style="margin-top:25px;" class="offset5">
