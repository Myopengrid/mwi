...
<div style="margin-top:30px;" class="row">
    ...
    <div class="span12">
        {{ Form::open(URL::base().'/'.ADM_URI.'/email/template', 'POST', array('class' => 'form-horizontal')) }}
        ...
        <div class="draggable-field ui-sortable">
            ...
            <div class="control-group {{ $errors->has('lang') ? 'error' : '' }}">
                ...
                <div class="controls">
                    ...
                    {{ Form::select('lang', $langs, Input::old('lang', 'en', array())) }}
            ...
            <div class="control-group {{ $errors->has('type') ? 'error' : '' }}">
                ...
                <div class="controls">
                    {{ Form::select('type', array('html' => 'HTML', 'text' => Lang::line('email::lang.Plain Text')->get(ADM_LANG)), Input::old('type', 'en', array())) }}
            ...
            <div class="control-group {{ $errors->has('body') ? 'error' : '' }}">
                ...
                <div class="controls">
                    {{ Form::textarea('body', Input::old('body', ''), array('class' => 'templates wysiwyg-advanced')) }}
