...
class Message {
	...
	{
		if (is_null($driver)) $driver = \Config::get('email.default', \Config::get('email::config.default'));

		if ( ! isset(static::$drivers[$driver]))
		{
			$config = \Config::get('email.transports.'.$driver, \Config::get('email::config.transports.'.$driver));
